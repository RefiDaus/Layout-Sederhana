...
DI BAWAH  INI ISI DARI CODINGAN INDEX HTML :
```javascript
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <body>
    <div id="container">
      ...
      <nav>
        ...
        <a href="layout/about.html">About</a>
        <a href="layout/kontak.html">Kontak</a>
      </nav>
      <section id="hero">
        <h1>Hello World!</h1>
        <p>
            TERIMA KASIH TELAH MENGUNJUNGI WEB SITE SAYA.WEB INI MASIH TARAF RENOVASI DAN MASIH SEPENUHNYA SEMPURNA DAN SAYA MENGUCAPKAN MINTA MAAF KALAU MASIH TIDAK SEMPURNA.
        </p>
        <a href="#"
